# Step 63 - 빌드 검증: Lighthouse CI 성능 베이스라인 수집
...
```
step63_성능베이스라인_chunk1.md (500줄 이하)
step63_성능베이스라인_chunk2.md (500줄 이하)
...
```
...
이 지침을 완료한 즉시 자동으로 step64.md를 읽고 수행한다. 사용자 확인을 기다리지 않는다.
