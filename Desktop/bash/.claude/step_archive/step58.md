...
Step 21 베이스라인 대비 중복률 증가 시 최적화 검증 실패로 간주한다.

**검증 결과는 청크 단위로 저장한다:**

```
step41_중복률검증_chunk1.md (500줄 이하)
step41_중복률검증_chunk2.md (500줄 이하)
...
```
...
이 지침을 완료한 즉시 자동으로 step59.md를 읽고 수행한다. 사용자 확인을 기다리지 않는다.
