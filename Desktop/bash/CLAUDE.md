...
**순서:**
`step01.md` → `step02.md` → ... → `step12.md` → ... → `step88.md`

**각 Step 처리 흐름:**
1. `.claude/step_archive/stepNN.md` 읽기 (Read 도구 1회)
2. 읽은 내용 즉시 실행
...
3. 전체 88개 Step 완료 시에만 최종 보고

### 보고 형식

```
✅ Step 23/88 완료
→ Step 24/88 읽기 및 실행 시작...
```
